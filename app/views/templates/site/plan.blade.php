        ...
        <div class="holder col-2 wside">
            <div class="row">
                ...
                <div class="side">
                    ...
                    <div class="unit"><a href="" class="download-file"><img src="{{ asset(Config::get('site.theme_path').'/images/ico-pdf.png') }}" class="ico">
                            <div class="info">
            ...
            <div class="row wide"><img src="{{ asset(Config::get('site.theme_path').'/images/visual-map-scheme.png') }}" class="visual map"></div>
            <div class="row">
                <div class="text">
            ...
            <div class="row scheme">
                <div class="visual"><img src="/images/visual-map-scheme-interactive.png"></div>
                <div class="side">
                    <div class="unit">
                        <div class="head"><img src="/images/ico-house-1.png" class="ico">
                    ...
                    <div class="unit">
                        <div class="head"><img src="/images/ico-house-2.png" class="ico">
